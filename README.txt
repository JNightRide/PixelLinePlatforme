...
This is the readme for PixelLinePlatformer, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. PixelLinePlatformer) > Ok.
...
- To run the project find PixelLinePlatformer.java (which will be in under src/main/java/com/nightridegame/pixellineplatformer) and right click > Run 'PixelLinePlatformer'
